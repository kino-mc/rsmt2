...
impl Solver {
  ...
  fn in_writer(& mut self) -> & mut std::io::Write {
  ...
  fn out_reader(& mut self) -> & mut std::io::Read {
  ...
  fn err_reader(& mut self) -> & mut std::io::Read {
  ...
  pub fn err_as_string(& mut self) -> std::io::Result<String> {
